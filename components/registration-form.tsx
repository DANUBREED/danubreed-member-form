...
const TRIBES = ["Diamond", "Ruby", "Emerald", "Amber", "None"]
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Parent’s Number */}
        <div className="space-y-3">
          <Label htmlFor="parentsNumber" className="text-sm font-semibold text-gray-700">
        ...
        {/* School Status */}
        <div className="space-y-3">
          <Label htmlFor="schoolStatus" className="text-sm font-semibold text-gray-700">
            School Status *
          </Label>
          <select
            id="schoolStatus"
        ...
        {/* Tribe */}
        <div className="space-y-3">
          <Label htmlFor="tribe" className="text-sm font-semibold text-gray-700">
            Tribe *
          </Label>
          <select
            id="tribe"
        ...
        <div className="space-y-3 md:col-span-2">
          <Label htmlFor="servingUnit" className="text-sm font-semibold text-gray-700">
            Serving Unit *
          </Label>
          <select
            id="servingUnit"
